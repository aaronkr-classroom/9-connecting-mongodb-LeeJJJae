...
mongoose.connect(
  "mongodb+srv://ut-node:WvwxUOCR1qtX1i2T@ut-node.shy2gcv.mongodb.net/?retryWrites=true&w=majority&appName=UT-node", // Atlas 경로
...
app.get("/subscriber", subscribersController.saveSubscriber);
